...
// .wrangler/tmp/pages-egsWdP/bundledWorker-0.6628916603259556.mjs
...
async function T(e, { request: t, assetsFetcher: a, ctx: s }, { path: n, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        r = S(await a.fetch(O(c, e.path ?? n))), e.headers && x(r.headers, e.headers);
        break;
      }
      case "static": {
...
var M = class {
  ...
  applyRouteDest(t, a, s) {
    ...
    return _(this.searchParams, b.searchParams), P(this.path) || (this.path = b.pathname), n;
  }
...
function Ne() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name2((t, a) => e.has(a) ? e.get(a) : Reflect.get(globalThis, a), "get"), set: /* @__PURE__ */ __name2((t, a, s) => je.has(a) ? Reflect.set(globalThis, a, s) : (e.set(a, s), true), "set") });
}
__name(Ne, "Ne");
__name2(Ne, "Ne");
...
var kt = { async fetch(e, t, a) {
  ...
  return n.run({ ...t, NODE_ENV: "production", SUSPENSE_CACHE_URL: R }, async () => i.run({ env: t, ctx: a, cf: e.cf }, async () => {
...
// ../../.npm/_npx/d77349f55c2be1c0/node_modules/wrangler/templates/pages-dev-util.ts
...
// .wrangler/tmp/pages-egsWdP/g2o8i1z4iq5.js
...
// .wrangler/tmp/bundle-YbjTm2/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-YbjTm2/middleware-loader.entry.ts
